        ...
        <section className="relative bg-stone-900 py-20 md:py-28 overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-6xl font-serif font-medium text-white mb-6">Warehouse solutions built around your business</h1>
              <p className="text-stone-300 font-sans font-light text-lg md:text-xl leading-relaxed">Comprehensive warehousing, storage, logistics, and warehouse development solutions — including nationwide custom warehouse solutions tailored for every commercial need.</p>
            </div>
          </div>
        </section>
        <motion.section
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <span className="text-red-700 font-bold uppercase tracking-widest text-xs font-sans">What we offer</span>
                <span className="w-8 h-[2px] bg-red-600"></span>
              </div>
              <h2 className="text-4xl md:text-5xl font-serif font-medium text-stone-900 mb-4">End-to-end warehouse solutions</h2>
            </div>
            <motion.div
              initial="hidden"
              whileInView="visible"
            ...
            <div className="text-center mt-12">
              <Link to="/book-warehouse" className="inline-flex items-center px-6 py-3 bg-red-700 text-white font-bold font-sans text-xs uppercase tracking-widest rounded-xl hover:bg-red-800 hover:-translate-y-1 transition-all duration-300">
                Calculate Your Requirement <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
            </div>
          </div>
        </motion.section>
